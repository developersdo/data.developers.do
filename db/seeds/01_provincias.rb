...
Detalle.create(descripcion: "Todos los municipios que pertenecen a una provincia.", verbo:"Get", url: "v1/provincias/2/municipios", formato_json: true, formato_xml: true, formato_csv: true, formato_xls: true, servicio_id: s.id)
